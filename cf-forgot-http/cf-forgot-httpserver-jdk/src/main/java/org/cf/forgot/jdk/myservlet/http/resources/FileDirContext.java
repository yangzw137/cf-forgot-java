...
//
//    private static final Logger log = LoggerFactory.getLogger(FileDirContext.class);
//
//    // -------------------------------------------------------------- Constants
//
//
...
//
//        if (file.isDirectory()) {
//            org.apache.naming.resources.FileDirContext tempContext = new org.apache.naming.resources.FileDirContext(env);
