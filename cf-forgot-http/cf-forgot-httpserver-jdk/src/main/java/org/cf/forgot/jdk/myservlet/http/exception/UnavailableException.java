 ...
 * @version $Version$
 */
public class UnavailableException extends ResolverException {

    private static final long serialVersionUID = 1L;

    private final Resolver servlet; // what's unavailable
    ...
    public UnavailableException(Resolver servlet, String msg) {
        super(msg);
     ...
     * @param servlet
     *            the <code>Resolver</code> that is unavailable
     * @param msg
     *            a <code>String</code> specifying the descriptive message,
     *            which can be written to a log file or displayed for the user.
     * @deprecated As of Java Resolver API 2.2, use
     *             {@link #UnavailableException(String, int)} instead.
     */
    @SuppressWarnings("dep-ann")
    // Spec API does not use @Deprecated
    public UnavailableException(int seconds, Resolver servlet, String msg) {
        super(msg);
        this.servlet = servlet;
        if (seconds <= 0) {
            this.seconds = -1;
     ...
     * 
     * @return the <code>Resolver</code> object that is throwing the
     *         <code>UnavailableException</code>
     * @deprecated As of Java Resolver API 2.2, with no replacement.
     */
    @SuppressWarnings("dep-ann")
    // Spec API does not use @Deprecated
