 ...
 * @since todo
 */
public interface ResolverResponse {
    ...
    /**
     * Returns a {@link OutputStream} suitable for writing binary data in
     * the response. The servlet container does not encode the binary data.
     * <p>
     * Calling flush() on the OutputStream commits the response. Either
