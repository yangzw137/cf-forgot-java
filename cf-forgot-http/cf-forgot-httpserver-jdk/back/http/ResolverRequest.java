 ...
 * @since todo
 */
public interface ResolverRequest {
     ...
     * also be set programatically using {@link #setAttribute}.
     ...
     * {@link InputStream}. Either this method or {@link #getReader} may
     * be called to read the body, not both.
     *
     * @return a {@link InputStream} object containing the body of the
     *         request
     ...
     * {@link ResolverContext#getRequestDispatcher} is that this method can take
     * a relative path.
     *
     * @param path
     ...
     * @see ResolverContext#getRequestDispatcher
     */
    public RequestDispatcher getRequestDispatcher(String path);

    /**
     * @deprecated As of Version 2.1 of the Java Resolver API, use
     *             {@link ResolverContext#getRealPath} instead.
     */
