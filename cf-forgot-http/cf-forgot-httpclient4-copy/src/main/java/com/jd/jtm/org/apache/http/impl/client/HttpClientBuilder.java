...
import com.jd.jtm.org.apache.http.ConnectionReuseStrategy;
import com.jd.jtm.org.apache.http.Header;
import com.jd.jtm.org.apache.http.HttpHost;
import com.jd.jtm.org.apache.http.HttpRequestInterceptor;
import com.jd.jtm.org.apache.http.HttpResponseInterceptor;
import com.jd.jtm.org.apache.http.auth.AuthSchemeProvider;
import com.jd.jtm.org.apache.http.client.AuthenticationStrategy;
import com.jd.jtm.org.apache.http.client.BackoffManager;
import com.jd.jtm.org.apache.http.client.ConnectionBackoffStrategy;
import com.jd.jtm.org.apache.http.client.CookieStore;
import com.jd.jtm.org.apache.http.client.CredentialsProvider;
import com.jd.jtm.org.apache.http.client.HttpRequestRetryHandler;
import com.jd.jtm.org.apache.http.client.RedirectStrategy;
import com.jd.jtm.org.apache.http.client.ServiceUnavailableRetryStrategy;
import com.jd.jtm.org.apache.http.client.UserTokenHandler;
import com.jd.jtm.org.apache.http.client.config.AuthSchemes;
import com.jd.jtm.org.apache.http.client.config.RequestConfig;
import com.jd.jtm.org.apache.http.client.entity.InputStreamFactory;
import com.jd.jtm.org.apache.http.client.protocol.RequestAcceptEncoding;
import com.jd.jtm.org.apache.http.client.protocol.RequestAddCookies;
import com.jd.jtm.org.apache.http.client.protocol.RequestAuthCache;
import com.jd.jtm.org.apache.http.client.protocol.RequestClientConnControl;
import com.jd.jtm.org.apache.http.client.protocol.RequestDefaultHeaders;
import com.jd.jtm.org.apache.http.client.protocol.RequestExpectContinue;
import com.jd.jtm.org.apache.http.client.protocol.ResponseContentEncoding;
import com.jd.jtm.org.apache.http.client.protocol.ResponseProcessCookies;
import com.jd.jtm.org.apache.http.config.ConnectionConfig;
import com.jd.jtm.org.apache.http.config.Lookup;
import com.jd.jtm.org.apache.http.config.RegistryBuilder;
import com.jd.jtm.org.apache.http.config.SocketConfig;
import com.jd.jtm.org.apache.http.conn.ConnectionKeepAliveStrategy;
import com.jd.jtm.org.apache.http.conn.DnsResolver;
import com.jd.jtm.org.apache.http.conn.HttpClientConnectionManager;
import com.jd.jtm.org.apache.http.conn.SchemePortResolver;
import com.jd.jtm.org.apache.http.conn.routing.HttpRoutePlanner;
import com.jd.jtm.org.apache.http.conn.socket.ConnectionSocketFactory;
import com.jd.jtm.org.apache.http.conn.socket.LayeredConnectionSocketFactory;
import com.jd.jtm.org.apache.http.conn.socket.PlainConnectionSocketFactory;
import com.jd.jtm.org.apache.http.conn.ssl.DefaultHostnameVerifier;
import com.jd.jtm.org.apache.http.conn.ssl.SSLConnectionSocketFactory;
import com.jd.jtm.org.apache.http.conn.ssl.X509HostnameVerifier;
import com.jd.jtm.org.apache.http.conn.util.PublicSuffixMatcher;
import com.jd.jtm.org.apache.http.conn.util.PublicSuffixMatcherLoader;
import com.jd.jtm.org.apache.http.cookie.CookieSpecProvider;
import com.jd.jtm.org.apache.http.impl.NoConnectionReuseStrategy;
import com.jd.jtm.org.apache.http.impl.auth.BasicSchemeFactory;
import com.jd.jtm.org.apache.http.impl.auth.DigestSchemeFactory;
import com.jd.jtm.org.apache.http.impl.auth.KerberosSchemeFactory;
import com.jd.jtm.org.apache.http.impl.auth.NTLMSchemeFactory;
import com.jd.jtm.org.apache.http.impl.auth.SPNegoSchemeFactory;
import com.jd.jtm.org.apache.http.impl.client.BasicCredentialsProvider;
import com.jd.jtm.org.apache.http.impl.client.CloseableHttpClient;
import com.jd.jtm.org.apache.http.impl.client.CookieSpecRegistries;
import com.jd.jtm.org.apache.http.impl.client.DefaultClientConnectionReuseStrategy;
import com.jd.jtm.org.apache.http.impl.client.DefaultConnectionKeepAliveStrategy;
import com.jd.jtm.org.apache.http.impl.client.DefaultHttpRequestRetryHandler;
import com.jd.jtm.org.apache.http.impl.client.DefaultRedirectStrategy;
import com.jd.jtm.org.apache.http.impl.client.DefaultUserTokenHandler;
import com.jd.jtm.org.apache.http.impl.client.IdleConnectionEvictor;
import com.jd.jtm.org.apache.http.impl.client.InternalHttpClient;
import com.jd.jtm.org.apache.http.impl.client.NoopUserTokenHandler;
import com.jd.jtm.org.apache.http.impl.client.ProxyAuthenticationStrategy;
import com.jd.jtm.org.apache.http.impl.client.SystemDefaultCredentialsProvider;
import com.jd.jtm.org.apache.http.impl.client.TargetAuthenticationStrategy;
import com.jd.jtm.org.apache.http.impl.conn.DefaultProxyRoutePlanner;
import com.jd.jtm.org.apache.http.impl.conn.DefaultRoutePlanner;
import com.jd.jtm.org.apache.http.impl.conn.DefaultSchemePortResolver;
import com.jd.jtm.org.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import com.jd.jtm.org.apache.http.impl.conn.SystemDefaultRoutePlanner;
import com.jd.jtm.org.apache.http.impl.execchain.BackoffStrategyExec;
import com.jd.jtm.org.apache.http.impl.execchain.ClientExecChain;
import com.jd.jtm.org.apache.http.impl.execchain.MainClientExec;
import com.jd.jtm.org.apache.http.impl.execchain.ProtocolExec;
import com.jd.jtm.org.apache.http.impl.execchain.RedirectExec;
import com.jd.jtm.org.apache.http.impl.execchain.RetryExec;
import com.jd.jtm.org.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import com.jd.jtm.org.apache.http.protocol.HttpProcessor;
import com.jd.jtm.org.apache.http.protocol.HttpProcessorBuilder;
import com.jd.jtm.org.apache.http.protocol.HttpRequestExecutor;
import com.jd.jtm.org.apache.http.protocol.ImmutableHttpProcessor;
import com.jd.jtm.org.apache.http.protocol.RequestContent;
import com.jd.jtm.org.apache.http.protocol.RequestTargetHost;
import com.jd.jtm.org.apache.http.protocol.RequestUserAgent;
import com.jd.jtm.org.apache.http.ssl.SSLContexts;
import com.jd.jtm.org.apache.http.util.TextUtils;
import com.jd.jtm.org.apache.http.util.VersionInfo;
